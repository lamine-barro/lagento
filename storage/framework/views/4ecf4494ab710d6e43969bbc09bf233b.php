<?php $__env->startSection('seo_title', 'Financement pour startups et PME à Abidjan - Horizon O'); ?>
<?php $__env->startSection('meta_description', 'Trouvez le financement parfait pour votre startup en Côte d\'Ivoire avec Horizon O. Subventions, prêts, investisseurs, concours - toutes les opportunités de financement à Abidjan et en Afrique.'); ?>
...
<?php $__env->startSection('og_title', 'Financement Startup PME Abidjan - Horizon O'); ?>
<?php $__env->startSection('og_description', 'Toutes les solutions de financement pour startups et PME en Côte d\'Ivoire. Horizon O vous guide vers les bonnes opportunités.'); ?>
