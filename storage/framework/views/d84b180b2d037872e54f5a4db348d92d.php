...
<?php $__env->startSection('page_title', 'Diagnostic Entreprise Gratuit - Analysez votre Startup avec l\'IA | Agento'); ?>
<?php $__env->startSection('seo_title', 'Diagnostic Entreprise Gratuit - Analysez votre Startup avec l\'IA | Agento'); ?>
...
<?php $__env->startSection('og_title', 'Diagnostic Entreprise IA Gratuit - Agento Côte d\'Ivoire'); ?>
...
<div class="container max-w-4xl mx-auto section px-4" x-data="{ 
    ...
    <div class="mb-4 flex items-center justify-between">
        <div>
            ...
            <p class="text-secondary text-sm"><?php echo e(isset($analytics) ? 'MAJ: ' . ($analytics->updated_at ? $analytics->updated_at->format('d/m/Y H:i') : 'N/A') : 'Vue d\'ensemble entrepreneuriale'); ?></p>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-4 rounded-lg border border-gray-200 bg-white opportunity-card">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <?php if(isset($opportunite['lien']) && !empty($opportunite['lien']) && $opportunite['lien'] !== 'non disponible' && $opportunite['lien'] !== 'N/A'): ?>
                                <?php
                                    $lien = $opportunite['lien'];
                                    // Ajouter https:// si pas de protocole
