        ...
        <form id="step1-form" method="POST" action="<?php echo e(route('onboarding.step1.process')); ?>" enctype="multipart/form-data" class="space-y-6 mt-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="nom_projet" value="<?php echo e(old('nom_projet', $projet->nom_projet ?? '')); ?>" placeholder="Ex: AgroTech CI" class="input-field w-full" maxlength="100" required />
                </div>
                <div>
