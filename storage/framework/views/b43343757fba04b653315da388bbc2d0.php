            ...
            <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card p-4 flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium truncate" style="color: var(--gray-900);" title="<?php echo e($filename); ?>">
                            <?php echo e($displayName); ?>

                        </p>
                        <p class="text-xs" style="color: var(--gray-500);"><?php echo e($sizeFormatted); ?></p>
                    </div>
                    
                    <!-- Actions simplifiées -->
                    <a href="<?php echo e(route('documents.download', $filename)); ?>" 
                       class="p-1.5 rounded-lg hover:bg-gray-100 transition-colors"
                       title="Télécharger">
                        <i data-lucide="download" class="w-4 h-4" style="color: var(--gray-500);"></i>
                    </a>
                    
                    <form method="POST" action="<?php echo e(route('documents.delete', $filename)); ?>" 
                          class="inline"
...
function documentUpload() {
    return {
        ...
        uploadFiles(files) {
            ...
            const existingDocs = <?php echo e(count($documents)); ?>;
