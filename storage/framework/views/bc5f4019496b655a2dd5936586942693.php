...
<head>
    ...
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'assistant IA côte ivoire, entrepreneuriat abidjan, startup ci, financement pme, conseil entrepreneur, innovation afrique'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', config('app.name', 'LAgentO') . ' - Assistant IA Entrepreneurial'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', 'LAgentO : Premier assistant IA pour entrepreneurs ivoiriens'); ?>">
    ...
    <meta property="twitter:title" content="<?php echo $__env->yieldContent('twitter_title', config('app.name', 'LAgentO') . ' - Assistant IA Entrepreneurial'); ?>">
    <meta property="twitter:description" content="<?php echo $__env->yieldContent('twitter_description', 'LAgentO : Premier assistant IA pour entrepreneurs ivoiriens'); ?>">
