<?php $__env->startSection('seo_title', 'Opportunités business pour entrepreneurs en Côte d\'Ivoire - Horizon O'); ?>
<?php $__env->startSection('meta_description', 'Découvrez toutes les opportunités business, appels d\'offres, concours et partenariats pour entrepreneurs en Côte d\'Ivoire avec Horizon O. Veille stratégique et intelligence business en temps réel.'); ?>
...
<?php $__env->startSection('og_title', 'Opportunités Entrepreneur Côte d\'Ivoire - Horizon O'); ?>
<?php $__env->startSection('og_description', 'Toutes les opportunités business pour entrepreneurs ivoiriens : concours, appels d\'offres, partenariats. Veille intelligente Horizon O.'); ?>
...

{
    ...
    "url": "<?php echo e(route('seo.opportunites')); ?>",
    ...
    "breadcrumb": {
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "item": "<?php echo e(route('seo.opportunites')); ?>"
...
<?php $__env->startSection('page_title', 'Opportunités Entrepreneur Côte d\'Ivoire'); ?>
<?php $__env->startSection('title', 'Opportunités Entrepreneur Côte d\'Ivoire'); ?>
    ...
    <section class="py-20" style="background: linear-gradient(135deg, var(--teal-600) 0%, var(--teal-500) 100%);">
        <div class="container max-w-4xl mx-auto px-4 text-center text-white">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="<?php echo e(route('seo.financement')); ?>" class="btn btn-lg px-8 py-4 text-lg" style="background: rgba(255,255,255,0.2); color: white; border: 2px solid white;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/laminebarro/agent-O/resources/views/seo/opportunites.blade.php ENDPATH**/ ?>