<?php $__env->startSection('seo_title', 'Assistant IA pour entrepreneurs en Côte d\'Ivoire - Horizon O'); ?>
<?php $__env->startSection('meta_description', 'Horizon O est le premier assistant IA spécialisé pour entrepreneurs ivoiriens. Conseils business personnalisés, opportunités de financement, diagnostic d\'entreprise et accompagnement 24/7. Gratuit pour startups en Côte d\'Ivoire.'); ?>
<?php $__env->startSection('meta_keywords', 'assistant IA entrepreneur, côte ivoire startup, conseiller business abidjan, assistant entrepreneur ivoirien, IA business africaine, lagento tech agro tech'); ?>
<?php $__env->startSection('canonical_url', route('seo.assistant-ia')); ?>

<?php $__env->startSection('og_title', 'Assistant IA Entrepreneur Côte d\'Ivoire - Horizon O'); ?>
...

{
    ...
    "description": "Horizon O est le premier assistant IA spécialisé pour entrepreneurs ivoiriens",
    ...
    "breadcrumb": {
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "item": "<?php echo e(route('seo.assistant-ia')); ?>"
...
<?php $__env->startSection('page_title', 'Assistant IA Entrepreneur Côte d\'Ivoire'); ?>
<?php $__env->startSection('title', 'Assistant IA Entrepreneur Côte d\'Ivoire'); ?>
    ...
    <section class="py-20" style="background: linear-gradient(135deg, var(--orange-primary) 0%, var(--orange-light) 100%);">
        <div class="container max-w-4xl mx-auto px-4 text-center text-white">
            <h1 class="text-4xl font-bold mb-6">
                LagentO - Assistant IA développé par Horizon O
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('landing')); ?>" class="btn btn-lg px-8 py-4 text-lg" style="background: white; color: var(--orange-primary);">
        ...
        <div class="container max-w-6xl mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold mb-4" style="color: var(--gray-900);">
                    Pourquoi choisir Horizon O en Côte d'Ivoire ?
                </h2>
    ...
    <section class="py-20">
        <div class="container max-w-4xl mx-auto px-4 text-center">
            ...
            <p class="text-lg mb-8" style="color: var(--gray-700);">
                Rejoignez les milliers d'entrepreneurs ivoiriens qui font confiance à Horizon O
            </p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/laminebarro/agent-O/resources/views/seo/assistant-ia-entrepreneur.blade.php ENDPATH**/ ?>