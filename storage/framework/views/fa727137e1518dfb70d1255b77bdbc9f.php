<?php $__env->startSection('seo_title', 'Tableau de Bord Entrepreneur - LAgentO Côte d\'Ivoire'); ?>
<?php $__env->startSection('meta_description', 'Accédez à votre tableau de bord entrepreneur : consultez vos projets, interactions avec l\'assistant IA, opportunités personnalisées et analytics de votre activité entrepreneuriale en Côte d\'Ivoire.'); ?>
<?php $__env->startSection('meta_keywords', 'dashboard entrepreneur, tableau bord startup, gestion projet ci, analytics business, assistant ia personnel'); ?>
            ...
            <div x-data="{ expanded: false }" class="bg-white rounded-lg border" style="border-color: var(--gray-100);">
                ...
                >
                    <div>
                        ...
                        <p class="text-sm mt-1" style="color: var(--gray-500);"><?php echo e($opportunities->count() ?? 0); ?> opportunités disponibles</p>
                    </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $opportunities ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opportunity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="border rounded-lg p-3 mb-3" style="border-color: var(--gray-100);">
                            <div class="flex items-start justify-between mb-2">
                                <h4 class="font-medium text-sm" style="color: var(--gray-900);"><?php echo e($opportunity->title); ?></h4>
                            ...
                            <p class="text-xs mb-2" style="color: var(--gray-700);"><?php echo e(Str::limit($opportunity->description, 100)); ?></p>
                            <div class="flex items-center justify-between">
                                <span class="text-xs" style="color: var(--gray-500);">
                                    Échéance: <?php echo e($opportunity->deadline); ?>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span class="text-sm font-medium" style="color: var(--orange-primary);"><?php echo e($project->viability_score ?? 75); ?>%</span>
                                </div>
                                <div class="h-2 rounded-full" style="background: var(--gray-100);">
                                    <div class="h-2 rounded-full" style="background: var(--orange-primary); width: <?php echo e($project->viability_score ?? 75); ?>%;"></div>
                                </div>
                            </div>
                ...
                <div x-show="expanded" x-transition class="px-4 pb-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="text-center p-3 rounded-lg" style="background: var(--gray-100);">
                            <div class="text-xl font-medium" style="color: var(--orange-primary);"><?php echo e($stats['messages_sent'] ?? 0); ?></div>
                            <div class="text-xs" style="color: var(--gray-500);">Messages envoyés</div>
                        </div>
                        <div class="text-center p-3 rounded-lg" style="background: var(--gray-100);">
                            <div class="text-xl font-medium" style="color: var(--orange-primary);"><?php echo e($stats['documents_generated'] ?? 0); ?></div>
                            <div class="text-xs" style="color: var(--gray-500);">Documents générés</div>
                        </div>
                        <div class="text-center p-3 rounded-lg" style="background: var(--gray-100);">
                            <div class="text-xl font-medium" style="color: var(--orange-primary);"><?php echo e($stats['opportunities_matched'] ?? 0); ?></div>
                            <div class="text-xs" style="color: var(--gray-500);">Opportunités matchées</div>
                        </div>
                        <div class="text-center p-3 rounded-lg" style="background: var(--gray-100);">
                            <div class="text-xl font-medium" style="color: var(--orange-primary);"><?php echo e($stats['time_saved'] ?? '0h'); ?></div>
