<?php $__env->startSection('seo_title', 'Diagnostic gratuit d\'entreprise en Côte d\'Ivoire - Horizon O'); ?>
<?php $__env->startSection('meta_description', 'Obtenez un diagnostic complet et gratuit de votre entreprise en Côte d\'Ivoire avec Horizon O. Analyse stratégique, recommandations personnalisées et plan d\'action pour développer votre business à Abidjan.'); ?>
...
<?php $__env->startSection('og_title', 'Diagnostic Entreprise Gratuit CI - Horizon O'); ?>
    ...
    <section class="py-20" style="background: linear-gradient(135deg, var(--blue-600) 0%, var(--blue-500) 100%);">
        <div class="container max-w-4xl mx-auto px-4 text-center text-white">
            ...
            <p class="text-xl mb-8 opacity-90">
                Une analyse complète de votre entreprise par l'intelligence artificielle Horizon O, adaptée au contexte ivoirien
            </p>
        ...
        <div class="container max-w-4xl mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold mb-6" style="color: var(--gray-900);">
                    Comment fonctionne le diagnostic Horizon O ?
                </h2>
        ...
        <div class="container max-w-4xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    ...
                    <p style="color: var(--gray-700);">"Le diagnostic Horizon O m'a aidé à identifier les vraies opportunités de mon secteur en CI. Les recommandations étaient très précises et adaptées au contexte local."</p>
                </div>
