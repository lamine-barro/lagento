<?php $__env->startSection('title', 'Historique des conversations'); ?>
    ...
    <div class="max-w-4xl mx-auto p-4 space-y-3">
        <?php $__empty_1 = true; $__currentLoopData = $conversations ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="border rounded-lg p-4 cursor-pointer hover:shadow-sm transition-shadow" 
                 ...
                 onclick="window.location.href = '<?php echo e(route('chat.index', ['conversation' => $conversation->id])); ?>'">
                ...
                <div class="flex items-start justify-between mb-2">
                        ...
                        <div class="flex-1">
                            ...
                            <?php if($conversation->last_message): ?>
                                <p class="text-xs mt-1 line-clamp-2" style="color: var(--gray-700);">
                                    <?php echo e(Str::limit($conversation->last_message, 100)); ?>

                                </p>
                            <?php endif; ?>
                            
                            <div class="flex items-center gap-4 mt-2 text-xs" style="color: var(--gray-500);">
                                <span><?php echo e($conversation->message_count); ?> messages</span>
                                <span><?php echo e($conversation->last_message_at?->diffForHumans() ?? $conversation->created_at->diffForHumans()); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                            ...
                            <!-- Pin/Unpin -->
                            <button 
                                @click.stop="togglePin(<?php echo e($conversation->id); ?>)"
                                class="w-full text-left px-3 py-2 text-sm hover:bg-gray-50 flex items-center gap-2"
                                style="color: var(--gray-700);"
                            >
                                <i data-lucide="<?php echo e($conversation->is_pinned ? 'pin-off' : 'pin'); ?>" class="w-4 h-4"></i>
                                <?php echo e($conversation->is_pinned ? 'Désépingler' : 'Épingler'); ?>

                            </button>
                            
                            <!-- Rename -->
                            <button 
                                @click.stop="renameConversation(<?php echo e($conversation->id); ?>, '<?php echo e($conversation->title); ?>')"
                                class="w-full text-left px-3 py-2 text-sm hover:bg-gray-50 flex items-center gap-2"
                                style="color: var(--gray-700);"
                            >
                            ...
                            <!-- Delete -->
                            <button 
                                @click.stop="deleteConversation(<?php echo e($conversation->id); ?>)"
                                class="w-full text-left px-3 py-2 text-sm hover:bg-gray-50 flex items-center gap-2"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/laminebarro/agent-O/resources/views/conversations/index.blade.php ENDPATH**/ ?>