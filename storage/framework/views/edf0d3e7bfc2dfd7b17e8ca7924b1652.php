...
<?php endif; ?>
    ...
    <div class="flex-1 w-full max-w-4xl mx-auto">
        ...
        <form id="step3-form" method="POST" action="<?php echo e(route('onboarding.step3.process')); ?>" class="space-y-6 mt-4">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex justify-between items-center mt-12 pt-6">
                <div class="w-full max-w-4xl mx-auto flex justify-between items-center gap-4 mt-4">
                    <a href="<?php echo e(route('onboarding.step2')); ?>" class="btn btn-ghost">
