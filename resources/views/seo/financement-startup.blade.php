...
@section('seo_title', 'Financement pour startups et PME à Abidjan - Agento')
@section('meta_description', 'Trouvez le financement parfait pour votre startup en Côte d\'Ivoire avec Agento. Subventions, prêts, investisseurs, concours - toutes les opportunités de financement à Abidjan et en Afrique.')
