    ...
    <main class="flex-1 flex items-center justify-center p-4">
        <div class="w-full max-w-2xl text-center">
            ...
            <p class="text-lg mb-8 mt-4" style="color: var(--gray-700);">
                LagentO a cartographié plus de <span class="text-2xl font-semibold" style="color: var(--primary);">2 000 milliards de FCFA</span> d'opportunités pour les jeunes entrepreneurs en Côte d'Ivoire à travers les initiatives gouvernementales et les écosystèmes. Il est disponible 24h/7 pour vous accompagner à les saisir.
            </p>
